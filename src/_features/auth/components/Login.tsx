...
import { Lock, Mail, ArrowRight, Eye, EyeOff, Dumbbell } from "lucide-react";
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                <span className="font-mono text-xs text-muted-foreground">Recordarme</span>
              </label>
              <Link href="/auth/forgot-password" className="font-mono text-xs text-primary hover:text-primary/80 transition-colors">
            ...
            >
              ...
              {isLoading ? (
                ...
                <>
                  <span className="relative z-10">Acceder a la Base</span>
