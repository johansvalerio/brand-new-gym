  ...
  return (
    ...
    >
      ...
      <div className="cta-content container relative z-10 text-center max-w-5xl px-6">
        <div className="cta-tag mb-8 inline-flex items-center gap-2.5 rounded-full border border-black/25 px-5 py-2 font-mono text-[11px] uppercase tracking-[0.3em] text-black/70">
        ...
        <h2 className="cta-title font-heading text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black uppercase text-primary-foreground mb-8 leading-[0.9] tracking-tighter">
          <span className="block overflow-hidden">
            <span className="cta-word inline-block">Listo para</span>
          </span>
          <span className="block overflow-hidden mt-2">
            <span className="cta-word inline-block text-primary-foreground relative">
          ...
          <span className="block overflow-hidden mt-2">
            <span className="cta-word inline-block">Tu</span>{" "}
            <span className="cta-word inline-block relative">
