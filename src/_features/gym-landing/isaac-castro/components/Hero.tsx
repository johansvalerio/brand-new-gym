...
const BAND_PHRASE = 'Disciplina // Hierro // Sin Atajos // Fuerza // Constancia // Mente Dura // Entrena Serio // Legado //';
...
/** Hero propio de isaac-castro: misma estructura/animación, voz de disciplina y hierro. */
export function IsaacCastroHero() {
  ...
  useGSAP(
    () => {
      ...
      mm.add('(prefers-reduced-motion: no-preference)', () => {
        ...
        /* Glitch autónomo en "FIRME" — ráfaga RGB cada ~1.2s, sin hover */
        gsap
  ...
  return (
    ...
    >
      {/* ░░ Background photo — fierros oscuros ░░ */}
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1526506118085-60ce8714f8c5?q=80&w=2070&auto=format&fit=crop')] bg-cover bg-center opacity-[0.30] grayscale contrast-125" />
      ...
      <h1 aria-label="Forja hierro, crea legado" className="relative z-10">
        {/* FORJA — solid */}
        <div className="overflow-hidden">
          <span aria-hidden="true" className="h5-word block font-heading font-black uppercase leading-[0.82] tracking-[-0.03em] text-[clamp(4rem,17vw,12.5rem)] lg:text-[length:min(14vw,18vh)] text-foreground cursor-default transition-colors duration-300 hover:text-primary">
            <span className="h5-word-inner block">Forja</span>
          </span>
        </div>
          ...
          >
            <span className="h5-word-inner block">
              <span className="relative inline-block">
                <span className="h5-glitch-main inline-block">Hierro</span>
                <span
                  aria-hidden="true"
        ...
        <div className="overflow-hidden">
          <span aria-hidden="true" className="h5-word block font-heading font-black uppercase leading-[0.85] tracking-[-0.03em] text-[clamp(2.6rem,10.5vw,8rem)] lg:text-[min(9vw,13vh)] pl-[3%] text-primary cursor-default transition-colors duration-300 hover:text-foreground">
            <span className="h5-word-inner block">Tu Legado</span>
          </span>
        </div>
      </h1>
      ...
      <div className="h5-cta relative z-10 container mx-auto px-6 mt-12 lg:mt-6 flex flex-col sm:flex-row gap-4">
        ...
        <Button
          ...
          className="bg-secondary text-primary hover:bg-secondary/80 font-heading tracking-wider uppercase text-base px-9 h-14 rounded-sm border border-primary/40 focus-visible:ring-primary hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 cursor-pointer sm:self-start"
        >
          Ver Planes
        </Button>
      </div>
      ...
      <div className="h5-foot relative z-10 container mx-auto px-6 mt-10 lg:mt-4">
        <p className="font-mono text-[10px] uppercase tracking-[0.26em] text-muted-foreground border-t border-border/60 pt-5">
          Cañas · Lun–Sáb · Disciplina y hierro
        </p>
      </div>
    </section>
  );
