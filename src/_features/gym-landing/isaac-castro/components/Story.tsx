...
/** Story propio de isaac-castro: misma cinemática pineada, frases distintas. */
export function IsaacCastroStory() {
  ...
  useGSAP(
    () => {
      ...
      mm.add("(prefers-reduced-motion: no-preference)", () => {
        ...
        const phrases = gsap.utils.toArray<HTMLElement>(".phrase", containerRef.current);
              ...
              {phrase.split(" ").map((word, wi) => (
                <span
                  ...
                  style={{
                    ...
                    color: "#ffffff",
                    textShadow: "0 0 40px color-mix(in srgb, var(--primary) 8%, transparent)",
                  }}
                >
                  {word}
                </span>
