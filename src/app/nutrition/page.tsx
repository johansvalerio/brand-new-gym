        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <header className="mb-10">
            ...
            <p className="mt-3 max-w-2xl font-mono text-sm leading-relaxed text-muted-foreground md:text-base">
              Planes con comidas, gramos de proteína y ficha técnica — como Rutinas pero para tu dieta. Comparte tus planes con la comunidad.
            </p>
          </header>

          <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-border bg-card/50 py-16 text-center">
            <Utensils className="h-10 w-10 text-muted-foreground/40" />
            <p className="mt-4 font-sans text-lg font-bold text-foreground">En construcción</p>
            <p className="mt-1 max-w-md font-mono text-sm text-muted-foreground">
              Estamos armando el catálogo de alimentos (USDA), wizard con calendario semanal y ranking de planes. Usa <span className="text-primary">Rutinas</span> como referencia.
            </p>
          </div>
        </div>
      </main>
